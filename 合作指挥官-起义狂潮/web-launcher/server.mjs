...
app.use('/api', bootstrapRouter, syncRouter, scenarioRouter, launchRouter, rebornLaunchRouter, rebornMapsRouter, airoLaunchRouter, airoMapsRouter, neuroLaunchRouter);
