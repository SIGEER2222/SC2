...
| 项目 | 值 |
| --- | --- |
| 地图目录 | `Maps/traynor01_7vs1.SC2Map` |
| 类型 | 战役改造 |
| MapScript.galaxy 行数 | 6266 |
| 触发器总数(gt_*_Func) | 121 |
| 全局变量数(gv_) | 82 |
| include 库 | `TriggerLibs/NativeLib`、`TriggerLibs/LibertyLib`、`TriggerLibs/CampaignLib`、`LibA070801C`、`Lib67C0F0E7`、`LibC0F50AA6`、`LibDF8E6945`、`Lib975E2FE9`、`LibE0EAE146` |
| 起始晶体矿 | 默认 |
| 起始高能瓦斯 | 默认 |
