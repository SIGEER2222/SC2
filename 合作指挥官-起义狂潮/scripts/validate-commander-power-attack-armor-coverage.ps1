...
$raynorTechs = @(
    @{ Unit = "EngineeringBayRaynor"; Ability = "EngineeringBayResearchRaynor"; Face = "TerranInfantryWeaponsLevel1"; Cmd = "Research1"; Upgrade = "TerranInfantryWeaponsLevel1"; Button = ""; Requirement = ""; Units = @("MarineRaynor", "FirebatRaynor", "MarauderRaynor"); ArmorUnits = @() },
    @{ Unit = "EngineeringBayRaynor"; Ability = "EngineeringBayResearchRaynor"; Face = "TerranInfantryWeaponsLevel2"; Cmd = "Research2"; Upgrade = "TerranInfantryWeaponsLevel2"; Button = ""; Requirement = ""; Units = @("MarineRaynor", "FirebatRaynor", "MarauderRaynor"); ArmorUnits = @() },
    @{ Unit = "EngineeringBayRaynor"; Ability = "EngineeringBayResearchRaynor"; Face = "TerranInfantryWeaponsLevel3"; Cmd = "Research3"; Upgrade = "TerranInfantryWeaponsLevel3"; Button = ""; Requirement = ""; Units = @("MarineRaynor", "FirebatRaynor", "MarauderRaynor"); ArmorUnits = @() },
    ...
    @{ Unit = "EngineeringBayRaynor"; Ability = "EngineeringBayResearchRaynor"; Face = "TerranInfantryArmorLevel1"; Cmd = "Research6"; Upgrade = "TerranInfantryArmorsLevel1"; Button = ""; Requirement = ""; Units = @("SCVRaynor", "MarineRaynor", "MedicRaynor", "FirebatRaynor", "MarauderRaynor"); ArmorUnits = @("SCVRaynor", "MarineRaynor", "MedicRaynor", "FirebatRaynor", "MarauderRaynor") },
    @{ Unit = "EngineeringBayRaynor"; Ability = "EngineeringBayResearchRaynor"; Face = "TerranInfantryArmorLevel2"; Cmd = "Research7"; Upgrade = "TerranInfantryArmorsLevel2"; Button = ""; Requirement = ""; Units = @("SCVRaynor", "MarineRaynor", "MedicRaynor", "FirebatRaynor", "MarauderRaynor"); ArmorUnits = @("SCVRaynor", "MarineRaynor", "MedicRaynor", "FirebatRaynor", "MarauderRaynor") },
    @{ Unit = "EngineeringBayRaynor"; Ability = "EngineeringBayResearchRaynor"; Face = "TerranInfantryArmorLevel3"; Cmd = "Research8"; Upgrade = "TerranInfantryArmorsLevel3"; Button = ""; Requirement = ""; Units = @("SCVRaynor", "MarineRaynor", "MedicRaynor", "FirebatRaynor", "MarauderRaynor"); ArmorUnits = @("SCVRaynor", "MarineRaynor", "MedicRaynor", "FirebatRaynor", "MarauderRaynor") },
