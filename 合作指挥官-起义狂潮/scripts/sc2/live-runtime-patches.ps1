...
function Set-LiveCommanderTestOverride {
    ...
    if ($TestSpawnPreset -eq "AbathurFusion") {
        ...
        [void]$functionBlock.AppendLine("}")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("void libKPVP_gf_codex_abathur_fusion_probe_write (string lp_key, string lp_value) {")
        [void]$functionBlock.AppendLine("    BankLoad(`"CampaignXCore`", 1);")
        [void]$functionBlock.AppendLine("    BankValueSetFromString(BankLastCreated(), `"XMRuntimeDebug`", lp_key, lp_value);")
        [void]$functionBlock.AppendLine("    BankSave(BankLastCreated());")
        [void]$functionBlock.AppendLine("}")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("void libKPVP_gf_codex_abathur_fusion_probe_snapshot (int lp_player, string lp_stage) {")
        [void]$functionBlock.AppendLine("    unitgroup lv_ravagers;")
        [void]$functionBlock.AppendLine("    unitgroup lv_mutalisks;")
        [void]$functionBlock.AppendLine("    unitgroup lv_brutCocoons;")
        [void]$functionBlock.AppendLine("    unitgroup lv_levCocoons;")
        [void]$functionBlock.AppendLine("    unitgroup lv_brutalisks;")
        [void]$functionBlock.AppendLine("    unitgroup lv_leviathans;")
        [void]$functionBlock.AppendLine("    unit lv_sample;")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    lv_ravagers = UnitGroup(`"RavagerAbathur`", lp_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("    lv_mutalisks = UnitGroup(`"MutaliskAbathur`", lp_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("    lv_brutCocoons = UnitGroup(`"BrutaliskCocoonRavager`", lp_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("    lv_levCocoons = UnitGroup(`"LeviathanCocoon`", lp_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("    lv_brutalisks = UnitGroup(`"Brutalisk`", lp_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("    lv_leviathans = UnitGroup(`"HotSLeviathan`", lp_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".RavagerCount`"), IntToString(UnitGroupCount(lv_ravagers, c_unitCountAlive)));")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".MutaliskCount`"), IntToString(UnitGroupCount(lv_mutalisks, c_unitCountAlive)));")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".BrutCocoonCount`"), IntToString(UnitGroupCount(lv_brutCocoons, c_unitCountAlive)));")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".LeviCocoonCount`"), IntToString(UnitGroupCount(lv_levCocoons, c_unitCountAlive)));")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".BrutaliskCount`"), IntToString(UnitGroupCount(lv_brutalisks, c_unitCountAlive)));")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".LeviathanCount`"), IntToString(UnitGroupCount(lv_leviathans, c_unitCountAlive)));")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_ravagers, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_sample = UnitGroupRandomUnit(lv_ravagers, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".RavagerType`"), UnitGetType(lv_sample));")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_mutalisks, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_sample = UnitGroupRandomUnit(lv_mutalisks, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".MutaliskType`"), UnitGetType(lv_sample));")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_brutCocoons, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_sample = UnitGroupRandomUnit(lv_brutCocoons, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".BrutCocoonType`"), UnitGetType(lv_sample));")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_levCocoons, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_sample = UnitGroupRandomUnit(lv_levCocoons, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".LeviCocoonType`"), UnitGetType(lv_sample));")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_brutalisks, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_sample = UnitGroupRandomUnit(lv_brutalisks, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".BrutaliskType`"), UnitGetType(lv_sample));")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_leviathans, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_sample = UnitGroupRandomUnit(lv_leviathans, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write((`"AbathurFusion.`" + lp_stage + `".LeviathanType`"), UnitGetType(lv_sample));")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("}")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("bool libKPVP_gt_codex_abathur_fusion_probe_Func (bool testConds, bool runActions) {")
        [void]$functionBlock.AppendLine("    unitgroup lv_ravagers;")
        [void]$functionBlock.AppendLine("    unitgroup lv_mutalisks;")
        [void]$functionBlock.AppendLine("    unit lv_unit;")
        [void]$functionBlock.AppendLine("    int lv_player;")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    if (!runActions) {")
        [void]$functionBlock.AppendLine("        return true;")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    lv_player = 1;")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_snapshot(lv_player, `"BeforeOrder`");")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    lv_ravagers = UnitGroup(`"RavagerAbathur`", lv_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_ravagers, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_unit = UnitGroupRandomUnit(lv_ravagers, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write(`"AbathurFusion.BeforeOrder.RavagerBiomass100`", IntToString(UnitBehaviorCount(lv_unit, `"BiomassBuff100`")));")
        [void]$functionBlock.AppendLine("        UnitIssueOrder(lv_unit, Order(AbilityCommand(`"EvolveToBrutaliskRavager`", 1)), c_orderQueueReplace);")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    lv_mutalisks = UnitGroup(`"MutaliskAbathur`", lv_player, RegionEntireMap(), UnitFilter(0, 0, (1 << c_targetFilterMissile), (1 << (c_targetFilterDead - 32)) | (1 << (c_targetFilterHidden - 32))), 0);")
        [void]$functionBlock.AppendLine("    if (UnitGroupCount(lv_mutalisks, c_unitCountAlive) > 0) {")
        [void]$functionBlock.AppendLine("        lv_unit = UnitGroupRandomUnit(lv_mutalisks, c_unitCountAlive);")
        [void]$functionBlock.AppendLine("        libKPVP_gf_codex_abathur_fusion_probe_write(`"AbathurFusion.BeforeOrder.MutaliskBiomass100`", IntToString(UnitBehaviorCount(lv_unit, `"BiomassBuff100`")));")
        [void]$functionBlock.AppendLine("        UnitIssueOrder(lv_unit, Order(AbilityCommand(`"EvolveToLeviathanMutalisk`", 1)), c_orderQueueReplace);")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_write(`"AbathurFusion.OrderIssued`", `"1`");")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_snapshot(lv_player, `"AfterOrder`");")
        [void]$functionBlock.AppendLine("    return true;")
        [void]$functionBlock.AppendLine("}")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("bool libKPVP_gt_codex_abathur_fusion_probe_late_Func (bool testConds, bool runActions) {")
        [void]$functionBlock.AppendLine("    if (!runActions) {")
        [void]$functionBlock.AppendLine("        return true;")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_fusion_probe_snapshot(1, `"LateSnapshot`");")
        [void]$functionBlock.AppendLine("    return true;")
        [void]$functionBlock.AppendLine("}")
        [void]$functionBlock.AppendLine("")
        ...
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_apply_full_biomass(lv_unit, lp_player, 100);")
        [void]$functionBlock.AppendLine("")
        ...
        [void]$functionBlock.AppendLine("    libKPVP_gf_codex_abathur_apply_full_biomass(lv_unit, lp_player, 100);")
        [void]$functionBlock.AppendLine("")
        [void]$functionBlock.AppendLine("    UIDisplayMessage(PlayerGroupSingle(lp_player), c_messageAreaChat, StringToText(`"Codex test init: Abathur fusion test units spawned.`"));")
        [void]$functionBlock.AppendLine("}")
        [void]$functionBlock.AppendLine("")
        ...
        [void]$functionBlock.AppendLine("        TriggerAddEventTimeElapsed(TriggerCreate(`"libKPVP_gt_codex_abathur_fusion_probe_Func`"), 2.0, c_timeGame);")
        [void]$functionBlock.AppendLine("        TriggerAddEventTimeElapsed(TriggerCreate(`"libKPVP_gt_codex_abathur_fusion_probe_late_Func`"), 10.0, c_timeGame);")
        [void]$functionBlock.AppendLine("    }")
        [void]$functionBlock.AppendLine("}")
        [void]$functionBlock.AppendLine("")
    }
